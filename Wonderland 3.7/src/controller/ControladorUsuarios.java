...
public class ControladorUsuarios {
    ...
    public static void llenaTablaCambio(JTable tablaMetodos, RolXML DatMet, Usuario usuario, DefaultTableModel dtm) {
        ArrayList<Usuario> Lista = DatMet.todosUsuarioRol();
        for (Usuario est : Lista) {
            if (est.getNombre().equals("No")){
                String[] row = {est.getSeudonimo(), est.getNombre(), est.getRol()};
                dtm.addRow(row);
            }
        }
