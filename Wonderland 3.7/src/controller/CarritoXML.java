...
public class CarritoXML {
    ...
    public static Element buscarSerialandName(List raiz, Productos dato,Usuario usu) {
        Iterator i = raiz.iterator();
        String serial = dato.getSerial();
        String nombre = usu.getSeudonimo();
        while (i.hasNext()) {
            Element e = (Element) i.next();
            System.out.println(serial);
            System.out.println(nombre);
            System.out.println(e.getChild("Serial").getText());
            System.out.println(e.getChild("Nombre").getText());
            if (serial.equals(e.getChild("Serial").getText()) && nombre.equals(e.getChild("Nombre").getText())) {
                return e;
            }
        }
        return null;
    ...
    public boolean borrarCarrito(Productos serial, Usuario usu) {
        boolean resultado = false;
        Element aux = new Element("Carrito");
        List Productos = this.root.getChildren("Carrito");
        while (aux != null) {
            aux = CarritoXML.buscarSerialandName(Productos, serial, usu);
            if (aux != null) {
                Productos.remove(aux);
                resultado = updateDocument();
            }
