...
public class MetodosDePago extends javax.swing.JFrame {
    ...
    public MetodosDePago(Usuario usu) {
        ...
        ControladorMetodos.llenaTablaMetodos(tablaMetodos, DatMet, usuario, dtm);
    }
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        int row = tablaMetodos.getSelectedRow();
        String id = tablaMetodos.getValueAt(row, 0).toString();
        DatMet.borrarMetodo(usuario.getSeudonimo(), id);
        JOptionPane.showMessageDialog(null, "Metodo de pago Eliminado", "Notificacion", JOptionPane.INFORMATION_MESSAGE);
        dtm.removeRow(tablaMetodos.getSelectedRow());
