 ...
 * @author Jessica
 */
public class SalicitudesCambio extends javax.swing.JFrame {
     ...
     */
    public SalicitudesCambio() {
        initComponents();
        
    }

    public SalicitudesCambio(Usuario usu) {
        initComponents();
        usuario = usu;
        ControladorUsuarios.Llenalista(modelo, List, DatRol);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalicitudesCambio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalicitudesCambio().setVisible(true);
            }
        });
    }
