...
public class Registro extends javax.swing.JFrame {
    ...
    public int validacionCampos() {
        int retorno = 0;
        String ci=cedulatxt.getText();
        if (Validar.validarVacio(nombretxt, "Debe indicar nombre") == 1 && Validar.validarVacio(apellidotxt, "Debe indicar Apellido") == 1 && Validar.validarVacio(cedulatxt, "Debe indicar Documento") == 1
                && Validar.validarVacio(emailtxt, "Debe indicar Correo") == 1 && Validar.validarVacio(direcciontxt, "Debe indicar direccion") == 1 && Validar.validarVacio(seudonimotxt, "Debe indicar Seudonimo") == 1
                && Validar.validarVacio(jPassword, "Debe indicar Contraseña") == 1 && Validar.validarComboBox(ComboBoxCorreo, "Debe indicar tipo de Correo") == 1 && Validar.validarComboBox(cedulaCombo, "Debe indicar tipo de Documento") == 1
                && Validar.validarFecha(fecha, "Debe indicar fecha de nacimiento") == 1&& Validar.validarEntero(ci, "Identificacion no es numerica")==1) {
