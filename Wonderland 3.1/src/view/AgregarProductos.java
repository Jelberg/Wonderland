...
public class AgregarProductos extends javax.swing.JFrame {
    ...
    public int validarCamposVacios() {
        if (Validar.validarVacio(nombretxt, "Debe indicar nombre del producto") == 1 && Validar.validarVacio(preciotxt, "Debe indicar precio") == 1 && Validar.validarVacio(cantidadtxt, "Debe indicar la cantidad del producto") == 1) {
            return 0;
        } else {
            return 1;
        }
    ...
    private void BotonContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonContinuarActionPerformed
        ...
        if (validarCamposVacios() != 1) {
            ControladorProductos.obtenerDatosPro(nombretxt.getText(), preciotxt.getText(), cantidadtxt.getText(), ControladorProductos.producirSerial(),usuario);
            this.dispose();
        }
